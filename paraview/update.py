# This update script was obtained from https://github.com/richti83/ParaView_Reader_for_LIGGGHTS/blob/master/python_macros/update.py
# All credit for this script should go to richti83
