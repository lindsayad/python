...
axPotential.plot(arc_length,potential,label='zapdos potential',linewidth=2)
axEField.plot(arc_length,efield,label='zapdos efield',linewidth=2)#,'--')
axEField.plot(x_data,efield_comsol,label='comsol efield',linewidth=2)#,'-.')
axPotential.plot(x_data,potential_comsol,label='comsol potential',linewidth=2)#':',)
